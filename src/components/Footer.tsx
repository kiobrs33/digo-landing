    ...
    <footer className="bg-primary text-white pt-16 pb-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="#planes" className="text-gray-300 hover:text-white transition-colors">Planes y Precios</a></li>
              <li><a href="#beneficios" className="text-gray-300 hover:text-white transition-colors">Beneficios</a></li>
              <li><a href="#cobertura" className="text-gray-300 hover:text-white transition-colors">Cobertura</a></li>
              <li><a href="#proceso" className="text-gray-300 hover:text-white transition-colors">Cómo Contratarnos</a></li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Condiciones de Servicio</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors">Política de Calidad</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-300">
              <li>Calle Principal 123, 28001 Madrid</li>
              <li>900 123 456</li>
              <li>info@fibernet.com</li>
        ...
        <div className="text-center text-gray-400 text-sm">
          <p>&copy; {new Date().getFullYear()} FiberNet. Todos los derechos reservados.</p>
        </div>
      </div>
    </footer>
  );
