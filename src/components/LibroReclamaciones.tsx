...
const schema = z.object({
  ...
  description: z.string().min(11, "Agrega una descripción, min 11 caracteres"),
});
...
const LibroReclamaciones = () => {
  ...
  const onSubmit = async (data: FormData) => {
    try {
      await axiosInstance.post("/claim", data, {
        headers: {
      ...
      setDialog({
        ...
        description: "Tu reclamo ha sido recibido. Te responderemos pronto.",
      });
    } catch (error) {
      console.error(
                ...
                <CardContent className="p-6">
                  <form className="space-y-6" onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className="text-sm text-gray-500">
                      ...
                      proporcionada es veraz y autorizas su tratamiento conforme
                  ...
                  <div>
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="flex items-start">
                        <MapPin
                          size={20}
                          className="text-secondary mr-4 mt-1"
                        />
                        <div>
                          <h4 className="font-medium text-gray-900">
                            Dirección
